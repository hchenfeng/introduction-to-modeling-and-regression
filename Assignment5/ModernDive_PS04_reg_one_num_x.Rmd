...
Since we are only looking at observational data, it is NOT reasonable to make causal conclusions. There could be other factors at issue that are not accounted for in this observation. 
