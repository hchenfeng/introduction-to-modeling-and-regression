...
author: "Chenfeng Hao"
date: "`r format(Sys.Date(), tz = 'ET', '%b %d, %Y')`"
output:
...
First I got my code working without it being a function.
```{r}
sd=2
mean=13
...
```{r}
#create a function called plotnorm
...
```{r}
curve(dnorm(x), -4, 4, ylim=c(0, 0.4), xlab="", 
      ylab="", bty="n", yaxs="i", 
      main="normal distribution", xaxt="n", yaxt="n")
...
For example, below illustrates that the sampling distribution of the the sample mean gets more normal as n
gets large even if the data is very skewed.
...
#in the matrix below each row is a simulated sample
