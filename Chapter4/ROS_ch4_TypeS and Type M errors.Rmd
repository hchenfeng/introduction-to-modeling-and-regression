...
vignette: |
  %\VignetteIndexEntry{An Introduction to Type S and M errors inHypothesis Testing} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
...
Below are simulated Z statistics, when they are bigger than 1.96 is absolute value we reject the null hypothesis using alpha = 0.05.
