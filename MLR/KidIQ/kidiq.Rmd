...
Data and regression of child's test score on maternal IQ with the solid line showing the fitted regression model and the light lines indicating uncertainty in the fitted regression.
...
Notice it looks really cloud like which is what we want.
